	...
	Class Configuration extends Controller
	{
		...
		*/
		public function save()
		{
			...
			{
				$data = array_merge($data, ['web_payment_method' => Upload::execute('payment', ['folder' => 'website/configuration/'])]);
			}

			// Delivery Service
			if(isset($_FILES['service']))
			{
				$data = array_merge($data, ['web_delivery_service' => Upload::execute('service', ['folder' => 'website/configuration/'])]);
			}
