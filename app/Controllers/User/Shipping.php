    ...
    Class Shipping extends Controller
    {
        ...
        */
        public function subdistrict()
        {
            ...
            curl_setopt_array($curl, array
            (
                CURLOPT_URL => raja_ongkir_url . 'subdistrict' . $url,
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_ENCODING => '',
                CURLOPT_MAXREDIRS => 10,
                CURLOPT_TIMEOUT => 30,
        ...
        */
        public function calculate()
        {
            ...
            curl_setopt_array($curl, array(
                ...
                CURLOPT_POSTFIELDS => 'origin=' . $from . '&originType=' . 'city' . '&destination=' . $to . '&destinationType=' . 'subdistrict' . '&weight=' . $weight . '&courier=' . $courier . '',
                CURLOPT_HTTPHEADER => array(
        ...
        */
        ...
        {
            $waybill = parent::post('no_resi');
            $courier = parent::post('courier');
            
            $curl = curl_init();
            curl_setopt_array($curl, array(
                CURLOPT_URL => raja_ongkir_url . 'waybill',
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_ENCODING => '',
                CURLOPT_MAXREDIRS => 10,
                CURLOPT_TIMEOUT => 30,
