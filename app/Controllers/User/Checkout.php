<?php
	...
	Class Checkout extends Controller
	{
		public function pdf_invoice($id)
		{
			...
			$checkout1 = $checkout->select('*,checkout_shipping.created_at as tanggal')
		...
		*/
		public function create()
		{
			...
			$create_checkout = Checkouts::create([
				...
				'check_description' => parent::post('address'),
		...
		*/
		public function post_manual()
		{
			...
			{
				$image = Upload::execute('proof_of_payment_1', ['folder' => 'transaction/proof/', 'max_size' => 2000000]);
			...
			$data['checp_payment_type'] = $payment;
