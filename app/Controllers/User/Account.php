	...
	Class Account extends Controller
	{
		...
		*/
		public function account_change()
		{
			...
			parent::set_session(['user_name' => $data['user_name']]);
			parent::set_session(['user_email' => $data['user_email']]);
			parent::set_session(['user_phone' => $data['user_phone']]);
			parent::set_session(['user_address' => $data['user_address']]);
