...
<html lang="<?= $website['web_language'] ?>" class="smart-style-2">
	<head>
		...
		<!-- #FAVICONS -->
		<link rel="shortcut icon" href="<?= base_url ?>public/website/configuration/<?= $website['web_icon'] ?>" type="image/x-icon">
		<link rel="icon" href="<?= base_url ?>public/website/configuration/<?= $website['web_icon'] ?>" type="image/x-icon">
		<!-- #GOOGLE FONT -->
	...
	<body class="desktop-detected pace-done smart-style-2">
		...
		<header id="header">
			<div id="logo-group">
				...
				<span style="color:white" id="logo"> <img src="<?= base_url ?>website/configuration/<?= $website['web_icon'] ?>" style="width: 30px" alt="Admin"> <?= $website['web_name'] ?></span>
				...
				<ul id="mobile-profile-img" class="header-dropdown-list hidden-xs padding-5">
					<li class="">
						<a href="#" class="dropdown-toggle no-margin userdropdown" data-toggle="dropdown"> 
							<img src="<?= base_url ?>website/configuration/<?= $website['web_icon'] ?>" class="online" alt="#">
			...
			<div class="login-info">
				<span> <!-- User image size is adjusted inside CSS, it should stay as it --> 
					...
					<a href="javascript:;" id="show-shortcut" data-action="toggleShortcut">
						<img src="<?= base_url ?>website/configuration/<?= $website['web_icon'] ?>" alt="me" class="online" /> 
						<span>
							<?= Request::sess('user_name'); ?>
						</span>
					</a> 
