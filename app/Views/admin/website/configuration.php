								...
								<fieldset>
									...
									<div class="row">
										<section class="col col-6">
											...
											<label class="input"> <i class="icon-prepend fa fa-file"></i>
												<input type="file" id="payment_method" accept="image/*">
											</label>
											<img id="paymen-method-reviews" src="<?= base_url ?>website/configuration/<?= $records['web_payment_method'] ?>" width="50%">
										</section>
										<section class="col col-6">
											<label class="label">Delivery Service</label>
											<label class="input"> <i class="icon-prepend fa fa-file"></i>
												<input type="file" id="delivery_service" accept="image/*">
											</label>
											<img id="delivery-service-reviews" src="<?= base_url ?>website/configuration/<?= $records['web_delivery_service'] ?>" width="50%">
										</section>
									</div>
									...
									<section>
										...
										<label class="textarea"> <i class="icon-prepend fa fa-align-justify"></i>
											<textarea id="addres" rows="3" placeholder="Website Description"><?= $records['web_addres'] ?></textarea>
										</label>
									</section>
...
<script type="text/javascript">
    ...
    $("#payment_method").change(function () {
        readURL(this, 'paymen-method-reviews')
    })

    $('#delivery_service').change(function () {
    	readURL(this, 'delivery-service-reviews')
    })
    ...
    $('#form').submit(ev =>
    {
        ...
        let payment = $('#payment_method')[0].files[0]
        let service = $('#delivery_service')[0].files[0]
