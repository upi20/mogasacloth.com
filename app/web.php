<?php
	...
	$app->add('/admin/dashboard/data', '\Admin\Dashboard','data','post');
	...
	$app->add('/admin/sales-order-pdf', '\Admin\Sales\OrderList', 'eksportPdf', 'post');
	...
	// Website Contact
	$app->add('/admin/website-contact', '\Admin\Website\Contact');
	$app->add('/admin/contact-create', '\Admin\Website\Contact', 'create', 'post');
	$app->add('/admin/contact-update', '\Admin\Website\Contact', 'update', 'post');
	$app->add('/admin/contact-delete', '\Admin\Website\Contact', 'destroy', 'delete');
	...
	// User
	$app->add('/admin/user', '\Admin\User\User');
	...
	// Action Blog
	$app->add('/blog-detail', '\User\Contact');
	$app->add('/contact/get_blog', '\User\Blog', 'get_blog', 'post');
	$app->add('/contact/kirim', '\User\Contact', 'kirim', 'post');
